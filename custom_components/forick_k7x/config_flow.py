...
class ForickK7xConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """UI 配置。"""
    ...
    def async_get_options_flow(entry: config_entries.ConfigEntry):
        ...
        return ForickK7xOptionsFlow()


class ForickK7xOptionsFlow(config_entries.OptionsFlow):
    """选项：IP/端口、设备 ID（可逗号分隔多从站）、轮询间隔。"""
